class Strings {
  ...
  static const String registrationTitle = "Создайте аккаунт";
  static const String forgotPasswordTitle = "Забыли пароль?";
  static const String emailHint = "Введите ваш email";
  static const String passwordHint = "Введите ваш пароль";
  ...
  static const String emailError = "Пожалуйста, введите корректный email.";
  ...
  static const String loginSuccess = "Вход успешно выполнен!";
  ...
  static const String newUserText = "Нет аккаунта?";
  static const String signUpLink = "Зарегистрироваться";
